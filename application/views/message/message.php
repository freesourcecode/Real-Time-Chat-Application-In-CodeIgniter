...
<body>
	<section id="main" class="bg-dark">
		<div id="chat_user_list" style="background-color: grey">
		...
		<div id="chatbox" style="background-color: skyblue">
			...
			<div class="chatting_section" id="chat_area" style="display: none">
				...
				<div id="chat_message_area" style="background-color: lightgrey">
		...
		<div id="details_of_user" style="background-color: skyblue">
	...
	<div id="update_container" style="background-color: skyblue">
